...
#define STAGE2_DEVBLIND		"/dev_blind/sys/stage2"
	...
	#define CB_LOCATION 		STAGE2 ".cex"
#elif defined (FIRMWARE_DEX)
	#define CB_LOCATION 		STAGE2 ".dex"
#endif
...
static void loaded_cobra()
{
	...
	cellFsUtilMount_h("CELL_FS_IOS:BUILTIN_FLSH1", "CELL_FS_FAT", "/dev_blind", 0, 0, 0, 0, 0);
	cellFsRename(STAGE2_DEVBLIND ".cex.bak", STAGE2_DEVBLIND ".cex");
	cellFsRename(STAGE2_DEVBLIND ".dex.bak", STAGE2_DEVBLIND ".dex");	
