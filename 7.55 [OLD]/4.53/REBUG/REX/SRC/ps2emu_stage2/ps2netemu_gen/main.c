...
#define read_iso_size_call			0x135DF0
#define fstat_iso_call				0x135CE4
#define open_iso_call1				0x135CA8 
#define open_iso_call2				0x136D2C 
#define read_config_size_call		0x12E328
#define open_config_call			0x12E304
#define decrypt_config_call			0x12E35C
...
#define PAYLOAD_ADDR		    	0x3940 
#define SH_ADDR						0x292348
